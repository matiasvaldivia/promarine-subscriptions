...
<main class="pm-portal-auth is-verify">
    ...
    <section class="pm-portal-verify-card">
        ...
        @if($demoCode)<div class="pm-portal-demo-code"><span>CÓDIGO DEMO FIJO</span><strong>{{ $demoCode }}</strong><small>Excepción exclusiva para el usuario de prueba local.</small></div>@endif
