...
<main class="pm-membership">
    ...
    <section class="pm-membership-hero">
        <div class="pm-membership-hero__copy">
            <span class="pm-membership-eyebrow">SUSCRIPCIÓN ANUAL · SIN COMPRA DE PRODUCTO</span>
            ...
            <div class="pm-membership-hero__actions">
                <a class="pm-membership-button" href="#sumarme">Obtener mi suscripción <span>→</span></a>
    ...
    <section class="pm-membership-benefits" aria-labelledby="beneficios">
        <div class="pm-membership-heading"><span>BENEFICIOS DEL PLAN ANUAL</span><h2 id="beneficios">Tu suscripción acompaña. <em>Vos decidís cuándo comprar.</em></h2></div>
    ...
    <section class="pm-membership-clarity">
        <div class="pm-membership-heading"><span>SIMPLE Y TRANSPARENTE</span><h2>Una suscripción. <em>Ningún producto agregado.</em></h2></div>
    ...
    <section class="pm-membership-steps">
        ...
        <div class="pm-membership-step-grid">
            <article><b>01</b><div><h3>Te sumás</h3><p>Registrás tu nombre y correo para solicitar la suscripción anual.</p></div></article>
    ...
    <section id="sumarme" class="pm-membership-enroll" x-data="{ step: {{ $errors->any() ? 2 : 1 }} }" x-cloak>
        ...
        <div class="pm-membership-plan-choice" x-show="step === 1" x-transition>
            ...
            <p>Un único acceso para disfrutar beneficios durante 12 meses. La suscripción no agrega productos ni inicia pedidos.</p>
        ...
        <form id="membership-form" class="pm-membership-form" method="POST" action="{{ route('membership.store') }}" x-show="step === 2" x-transition>
            ...
            <button class="pm-membership-button" type="submit">Quiero mi suscripción anual <span>→</span></button>
