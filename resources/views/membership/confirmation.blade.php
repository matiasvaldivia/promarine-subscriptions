<x-layouts.app title="Solicitud de membresía recibida">
<main class="pm-membership-confirmation">
    <section>
        ...
        <p>Tu solicitud de membresía anual quedó guardada sin agregar productos, crear pedidos ni realizar pagos.</p>
        <dl><div><dt>Plan</dt><dd>Membresía anual</dd></div><div><dt>Estado</dt><dd>Pendiente de confirmación</dd></div><div><dt>Productos</dt><dd>Ninguno</dd></div><div><dt>Cobro</dt><dd>$ 0 · demostración</dd></div></dl>
        ...
        <p class="pm-membership-confirmation__notice">Promarine deberá comunicarte el valor anual, los descuentos y las condiciones definitivas antes de activar una membresía real.</p>
